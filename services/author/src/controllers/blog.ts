...
import { invalidateChacheJob } from "../utils/rabbitqmq.js";
...
export const aiTitleResponce = TryCatch(async (req, res) => {
  const { text } = req.body;
...
export const aiDescriptionResponce = TryCatch(async (req, res) => {
